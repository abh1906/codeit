...
var pname=document.getElementById("pname").value;
        ...
        xmlhttp.open("GET", "checkp.php?q="+pname+"&p="+aname, true);
        xmlhttp.send();
		...
		<div id="main-content-problem" class="box white">
			<table id="problem-page-top">
				<tr>
					...
					<td>
						<input type="text" required="required" placeholder="Enter Asg_No." id="aname" name="aid"style="width: 400px;">
						<div id="aerror"></div>
					</td>	
				</tr>
				<tr>
					...
					<td>
						<input type="text" required="required" placeholder="Enter Problem_Id" name="pid" id="pname" style="width: 400px;" onkeyup="checkp()">
						<div id="perror"></div>
					</td>	
				</tr>
			</table>

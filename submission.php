...
$sql="select * from submission where codeid='".$uname."'";
	...
	<div class="inner-wrapper rounded-cr-body">
		<div id="main-content-problem" class="box white">
			<table id="problem-page-top">
				<tr>
					<td width="55%">
						<h1 class="title" style="color: #1c7473 ;"> MY SUBMISSIONS </h1>
					</td>	
				</tr>
			</table>
			<br>
            ...
            <h3 style="color: #656565;font-size: 18px;margin: 12px 330px;font-weight: 700; margin-bottom: 12px;">SOLVED</h3>
        </div>
        <br>
...
?>
                        <td><a href="ques.php?q=<?php echo $row["pid"]?>"> <?php echo $row["pid"]?> </a> </td>
